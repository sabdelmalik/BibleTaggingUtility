...
namespace BibleTaggingUtil
{
    class Constants
    {
        ...
        /// </summary>
        public static Dictionary <string, BookCategory> ubsNames = new Dictionary<string, BookCategory>()
        {
            {"Gen", BookCategory.Law },
            {"Exo", BookCategory.Law },
            {"Lev", BookCategory.Law },
            {"Num", BookCategory.Law },
            {"Deu", BookCategory.Law },
            {"Jos", BookCategory.History },
            {"Jdg", BookCategory.History },
            {"Rut", BookCategory.History },
            {"1Sa", BookCategory.History },
            {"2Sa", BookCategory.History },
            {"1Ki", BookCategory.History },
            {"2Ki", BookCategory.History },
            {"1Ch", BookCategory.History },
            {"2Ch", BookCategory.History },
            {"Ezr", BookCategory.History },
            {"Neh", BookCategory.History },
            {"Est", BookCategory.History },
            {"Job", BookCategory.Poetry },
            {"Psa", BookCategory.Poetry },
            {"Pro", BookCategory.Poetry },
            {"Ecc", BookCategory.Poetry },
            {"Sng", BookCategory.Poetry },
        ...
        public static string[] osisAltNames2 =
        {
            "Gen",
            "Exo",
            "Lev",
        ...
        /* protected */
        public static int[][] SVD_LAST_VERSE =
    {
        // Genesis
        new int[]
        {
        ...
        // I Timothy ** chapter 6 is 22 verses instead of 21
        new int[]
        {
           20,  15,  16,  16,  25,  22,
        },
